  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Dhanush Abhiram",
          from_email: form.email,
          to_email: "dhanush.sr03@gmail.com ",
      ...
      >
        ...
        <div className="flex flex-col gap-4 mt-5 text-white">
          <div className="flex items-center gap-2">
            <FaPhone className="text-[#915eff]" />
            <p>(716) 612-0897</p>
          </div>
          <div className="flex items-center gap-2">
    <FaEnvelope className="text-[#915eff]" />
    <p>dhanush.sr03@gmail.com</p>
  </div>
          <div className="flex items-center gap-2">
            <FaLinkedin className="text-[#915eff]" />
            <a 
              href="https://www.linkedin.com/in/abhiram03/" 
              target="_blank" 
